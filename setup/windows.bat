...
haxelib git flixel https://github.com/Slushi-Github/SLE-flixel Main-SCE
...
haxelib git fnf-modcharting-tools https://github.com/Slushi-Github/SLE-FNF-Modcharting-Tools main-old
