...
class CreditsState extends MusicBeatState
{
  ...
  override function create()
  {
    ...
    var defaultList:Array<Array<String>> = [
      ...
      ['Slushi Engine\'s Team'],
			[
				'Andres',
				'slushi',
				'Creator and main programmer of Slushi Engine',
			...
			[
				'Trock',
				'trock',
				'Programmer of Slushi Engine\nEnhancement to engine README on Github',
				'https://github.com/Gametrock',
				'0204C7'
			],
			[
				'Edwhak_Killbot',
				'edwhak',
				'Creator of Hitmans AD, which SLE uses certain codes',
