...
import utils.funkin.FunkinTools;
import utils.funkin.Scoring;
import backend.PsychCamera;
import utils.funkin.FlxAtlasSprite;
import utils.funkin.LeftMaskShader;
...
using utils.funkin.FunkinTools;
