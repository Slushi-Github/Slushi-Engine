...
class TurboActionHandler extends FlxBasic
{
  ...
  function new(action:String, delay:Float = DEFAULT_DELAY, interval:Float = DEFAULT_INTERVAL, gamepadOnly:Bool = false)
  {
    super();
    this.action = action;
    this.delay = delay;
   ...
   */
  public static overload inline extern function build(action:String, ?delay:Float = DEFAULT_DELAY, ?interval:Float = DEFAULT_INTERVAL):TurboActionHandler
  {
