package slushi.slushiEngineHUD;
...
class SlushiEngineHUD extends FlxSprite
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////////
	#if windows
	public static function setWindowColorWithNoteHit(note:Int):Void
	{
		switch (note)
		{
			case 0:
	...
	static function startColorTween(index:Int, forward:Bool, duration:Float):Void
	{
		...
		// I can't understand how to use this for the window border color.
